...
const translations = {
  "zh-Hans": {
    ...
    billingEyebrow: "计费",
    topUpTitle: "充值额度",
    topUpCopy: "Phase 1 先用人工充值。把账号邮箱和需要的分钟数发给管理员，审批后额度会显示在这里。",
  ...
  "zh-Hant": {
    ...
    billingEyebrow: "計費",
    topUpTitle: "儲值額度",
    topUpCopy: "Phase 1 先採人工儲值。把帳號信箱和需要的分鐘數交給管理員，核准後額度會顯示在這裡。",
    starterPackTitle: "Starter",
  ...
  en: {
    ...
    topUpCopy: "Phase 1 uses manual top-up. Send the operator your account email and desired minutes; credits appear here after admin approval.",
    starterPackTitle: "Starter",
  ...
  ja: {
    ...
    billingEyebrow: "課金",
    topUpTitle: "クレジットを追加",
    topUpCopy: "Phase 1 は手動チャージです。アカウントのメールと必要な分数を管理者に伝えると、承認後ここに反映されます。",
    starterPackTitle: "Starter",
