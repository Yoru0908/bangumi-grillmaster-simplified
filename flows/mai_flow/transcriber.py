...
# Domain terms for phraseList biasing — Sakurazaka46 / Showroom context.
DEFAULT_PHRASES = [
    "櫻坂46", "小田倉麗奈", "小島凪紗", "村山美羽", "的野美青", "山下瞳月",
    "谷口愛季", "中嶋優月", "向井純葉", "村井優", "石森璃花", "遠藤理子",
    "遠藤光莉", "大園玲", "大沼晶保", "幸阪茉里乃", "武元唯衣", "田村保乃",
    "藤吉夏鈴", "増本綺良", "松田里奈", "森田ひかる", "守屋麗奈", "山﨑天",
    "Showroom", "三期生", "Buddies", "クララ",
]
