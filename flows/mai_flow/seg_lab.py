"""Prompt-iteration test bench for mai_flow segmentation.
...
Usage (from repo root):
    ...
    uv run python -m flows.mai_flow.seg_lab <asr.json> [options]
...
from flows.mai_flow.llm import generate_json  # noqa: E402
from flows.mai_flow.segment_llm import (  # noqa: E402
    PROMPT_PATH,
    _format_atom,
    build_atoms,
)
